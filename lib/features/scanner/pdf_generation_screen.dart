                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(LucideIcons.info, color: AppTheme.textMuted, size: 12),
                              SizedBox(width: 6),
                              Text(
                                'Advertisement',
                                style: TextStyle(
                        ...
                        // Ad content placeholder - Replace with AdMob banner
                        Flexible(
                          child: Container(
                            width: double.infinity,
                            ...
                            child: const Column(
                              ...
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(LucideIcons.play, color: AppTheme.textMuted, size: 48),
                                SizedBox(height: 12),
                                Text(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    'Integrate Google AdMob banner here\nfor user retention and monetization',
                                    style: TextStyle(
                                      color: AppTheme.textMuted,
                                      fontSize: 11,
                                    ),
                        ...
                        const Padding(
                          ...
                          child: Text(
                            'Ads help keep ZeScan free for everyone',
                            style: TextStyle(
                              color: AppTheme.textMuted,
                              fontSize: 11,
                            ),
